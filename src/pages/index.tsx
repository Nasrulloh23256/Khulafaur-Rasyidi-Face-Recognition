          ...
          <div className="container mx-auto px-4">
            ...
            >
              {features.map((feature) => (
                <motion.div key={feature.title} className="rounded-lg border border-border bg-card p-6 shadow-card transition-all hover:-translate-y-1 hover:shadow-soft" variants={fadeUp}>
                  <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-lg gradient-primary">
